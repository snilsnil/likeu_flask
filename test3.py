...
output_path = './test_output/output_video.mp4'
        ...
        for result in results:
            ...
            for i, box in enumerate(boxes):
                ...
                if track_id == 2:
                    ...
                    if start_frame != 0 and (right_hand_y > high_hand_y or left_hand_y > high_hand_y):
                        high_hand_y = max(right_hand_y, left_hand_y)
                        ...
                        # 키포인트 데이터를 CSV에 기록
                        row = [frame_number, keypoint, elbow_angle, knee_angle]  # 키포인트 좌표 저장
