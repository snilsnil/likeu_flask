        ...
        for result in results:
            ...
            for i, box in enumerate(boxes):
                ...
                if track_id == 1:
                    ...
                    if start_frame != 0 :
                        if right_hand_y > right_high_hand_y and left_hand_y > left_high_hand_y:
                            if right_hand_y > right_high_hand_y:
                                right_high_hand_y = right_hand_y
                            if left_hand_y > left_high_hand_y:
                                left_high_hand_y = left_hand_y
        ...
        for result in results:
            ...
            for i, box in enumerate(boxes):
                ...
                if track_id == 1:
                    ...
                    # start_frame과 end_frame 사이에서만 데이터 저장
